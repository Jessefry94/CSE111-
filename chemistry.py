...
def compute_molar_mass(symbol_quantity_list, periodic_table_dict):
    ...
    for i in symbol_quantity_list:
        ...
        total_molar_mass += answer
    # Return the total molar mass.
    return total_molar_mass

def main():
    molecule_input = input("Enter the molecular formula of the sample ")
    grams_input = float(input("Enter the mass in grams of the sample "))
    periodic_table_dict = make_periodic_table()
    symbol_quantity_list = parse_formula(molecule_input, periodic_table_dict)
    calling_compute_molar_mass = compute_molar_mass(symbol_quantity_list, periodic_table_dict)
    number_of_moles = grams_input/calling_compute_molar_mass

    print(calling_compute_molar_mass)
    ...
    #     # we use range and len to cound through the list so we can print
    #     # specific parts of the list seperated through commas

    #     # Here is an example from mike in class to get rid of brackets in print terminal
    #     # print(periodic_table_list[i][1] , periodic_table_list[i][2])
    #     print(periodic_table_list[i][1:3])
#Shift+alt+I ---- home --- ctrl arrow
